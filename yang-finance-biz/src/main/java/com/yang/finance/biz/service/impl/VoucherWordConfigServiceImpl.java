...
import com.yang.finance.biz.dto.form.DelVoucherWordConfigForm;
import com.yang.finance.biz.dto.form.UpdateVoucherWordConfigDefaultFlagForm;
import com.yang.finance.biz.dto.form.UpdateVoucherWordConfigForm;
import com.yang.finance.biz.dto.vo.GetVoucherWordConfigVo;
import com.yang.finance.biz.dto.vo.ListVoucherWordConfigVo;
import com.yang.finance.biz.mapper.VoucherWordConfigMapper;
import com.yang.finance.biz.service.VoucherWordConfigService;
...
import static com.yang.finance.biz.domain.VoucherWordConfigField.*;
...
public class VoucherWordConfigServiceImpl implements VoucherWordConfigService {
    ...
    public boolean update(UpdateVoucherWordConfigForm form) {
        //根据键入名称查询数据库
        VoucherWordConfig voucherWordConfig = getByVoucherWord(form.getVoucherWord());
        //当前更改ID跟创建后ID不同(要同一个ID才能更改,不然同时出现两个ID一样的内容很奇怪)
        if (voucherWordConfig != null
