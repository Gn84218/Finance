...
public class SubjectField {
    ...
    public static DbField Level = new DbField("level","level","TINYINT","java.lang.Integer");
    ...
    public static DbField SubjectType = new DbField("subject_type","subjectType","INTEGER","java.lang.Integer");
