        ...
        <Card title={
            ...
            >
                <Table
                        ...
                        return <>
                            <Flex gap="middle">
                                ...
                                >
                                    ...
                                    <Space>
                                        <Upload>
                                            <Button icon={<UploadOutlined />} type="dashed" danger>添加附件</Button>
                                        </Upload>
                    ...
                    footer={() => {
                        return <Flex>
                            <Space>制单人：程序员八哥<Button icon={<EditOutlined />} title='修改制单人' onClick={() => { history.push('/System/PersonalInfo') }}></Button></Space>
                        </Flex>
                    }}
                />
