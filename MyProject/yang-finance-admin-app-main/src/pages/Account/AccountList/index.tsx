    ...
    const columns: ProColumns<API.ListAccountBookVoItem>[] = [
        ...
        },
        {
            ...
            render: (text, record, _, action) => [
                ...
                //     编辑
                // </a>,
                <a href={"/FinanceSetting/AccountList/AccountUpdate?id=" + record.id.toString()} rel="noopener noreferrer" key="editable">
                    编辑
                </a>,
                <a href={"/FinanceSetting/AccountList/AccountDetail?id=" + record.id.toString()} rel="noopener noreferrer" key="view">
                    查看
                </a>,
                <a onClick={() => {
                    Modal.confirm({
    ...
    return (
        <PageContainer>
            <ProTable<API.ListAccountBookVoItem, API.PageParams>
                ...
                headerTitle="账套列表"
                toolBarRender={() => [
                    <Button key="button" icon={<PlusOutlined />} type="primary" href='/FinanceSetting/AccountList/AccountCreate'>
                        新建
                    </Button>,
                    // <Dropdown
                    //   key="menu"
