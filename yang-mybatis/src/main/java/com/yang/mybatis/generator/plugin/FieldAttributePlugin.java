package com.yang.mybatis.generator.plugin;
...
//        root.addImportedType(model + "." + queryVoName);
        ...
        root.addImportedType("com.yang.mybatis.help.DbField");
        root.addImportedType("com.yang.mybatis.help.FieldResult");
        ...
        for (IntrospectedColumn column : allColumns) {
            ...
            Field field = new Field(varName,
                    new FullyQualifiedJavaType("com.yang.mybatis.help.DbField"));
            ...
            setMethod.setReturnType(new FullyQualifiedJavaType("com.yang.mybatis.help.FieldResult"));
